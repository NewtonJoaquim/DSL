...
/**
 * This is the item provider adapter for a {@link linhaDeProducao.Resource} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResourceItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Resource_id_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Resource_id_feature", "_UI_Resource_type"),
						LinhaDeProducaoPackage.Literals.RESOURCE__ID, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Resource_name_feature",
								"_UI_Resource_type"),
						LinhaDeProducaoPackage.Literals.RESOURCE__NAME, true, false, false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Resource_type_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Resource_type_feature",
								"_UI_Resource_type"),
						LinhaDeProducaoPackage.Literals.RESOURCE__TYPE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
